...
print "<button onClick = 'upload()' type = 'button'>Upload New Picture</button>"
print "</div><br/><br/>"
...
if(len(jpgnames)):
	...
	for name in jpgnames: 
		...
		print "<input type = 'submit' value = 'Edit' name = 'editted'></input>"
		print "</form>"
		...
		print "<input type = 'submit' value = 'Delete' name = 'deleteit'></input>"
		print "</form>"
